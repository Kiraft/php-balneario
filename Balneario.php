...
<head>
    ...
    <link rel="stylesheet" href="./CSS/Balneario.css">
...
<body>
    ...
    <div class="btncontainer">
        <div class="btn-float">
            <a class="btn" href="./reservas.php"><i class='bx bxs-calendar'></i>Reservar</a>
        </div>
    </div>
    ...
    <main>
        ...
        <section class="contenedor" id="nosotros">
            ...
            <div class="contenedor-nosotros">
                <img src="./IMG/balneario.jpeg" width="600px">
            ...
            <br>
            <div class="contenedor-nosotros">
                <img src="./IMG/balneario2.jpg" width="600px">
                <div class="nadar-nosotros">
                    <div class="nosotros">
